...
import { ICON_PATHS, ICON_VIEWBOX, ICON_SIZE } from "../../icons/icon-paths.js";
...
export function Icon({ name, size = "md", color, title, style }) {
  ...
  const px = typeof size === "number" ? size : ICON_SIZE[size] || ICON_SIZE.md;
  ...
  return (
    <span
      ...
      dangerouslySetInnerHTML={{
        __html:
          '<svg width="100%" height="100%" viewBox="' + ICON_VIEWBOX + '" fill="none">' + body + "</svg>",
      }}
    />
  );
}
